...
class MarkerChartWidget extends StatefulWidget {
  final DateTime selectedDate;
  const MarkerChartWidget({super.key, required this.selectedDate});

  @override
  State<MarkerChartWidget> createState() => _MarkerChartWidgetState();
}

class _MarkerChartWidgetState extends State<MarkerChartWidget> {
